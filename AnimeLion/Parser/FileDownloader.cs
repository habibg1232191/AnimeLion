...
namespace CodeProject.Downloader
{
    ...
    public class FileDownloader
    {
        ...
        private void OnDownloadComplete(long totalDownload)
        {
            if (this.DownloadComplete != null)
                this.DownloadComplete(this, new DownloadCompletedEventArgs(totalDownload));
        }
        ...
        public void Download(string url, string destFolder)
        {
            ...
            try
            {
                ...
                if (!gotCanceled)
                    OnDownloadComplete(totalDownloaded);
            }
        ...
        {
            ThreadPool.QueueUserWorkItem((WaitCallbackMethod), new [] { url, "" });
        }
        /// <summary>
        ...
        {
            ThreadPool.QueueUserWorkItem(WaitCallbackMethod, new[] { url, destFolder });
        }
        /// <summary>
    ...
    public class DownloadEventArgs : EventArgs
    {
        ...
        public DownloadEventArgs(long totalFileSize, long currentFileSize)
        {
            ...
            this.percentDone = (double) currentFileSize / totalFileSize * 100;
        }
    ...
    public class DownloadCompletedEventArgs : EventArgs
    {
        ...
        public DownloadCompletedEventArgs(long totalFileSize)
        {
            this.totalFileSize = totalFileSize;
        }
    }
